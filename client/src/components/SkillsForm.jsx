    ...
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            ...
            <button
                ...
                className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disbled:cursor-not-allowed'
            >
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tips:</strong>     Add 8-12 relevant skills to enhance your profile. Include both technical skills (programming languages, tools) and soft skills (communication, teamwork).</p>
        </div>
    </div>
  )
}
